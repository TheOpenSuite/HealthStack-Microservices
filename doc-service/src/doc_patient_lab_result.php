            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Patient Lab Results</h4>
                            </div>
                        </div>
                    </div>     
                    <!-- end page title --> 
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="header-title">Patient Lab Results</h4>
                                <div class="mb-2">
                                    <div class="row">
                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        <?php
                                            ...
                                            */
                                            ...
                                            // Modify the query to filter patients based on the logged-in doctor's ID
                                            $ret = "SELECT * FROM laboratory WHERE lab_doc_id = ? ORDER BY lab_date_rec DESC";
