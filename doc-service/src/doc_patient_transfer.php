                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            $ret = "SELECT * FROM patients WHERE pat_type = 'InPatient' AND pat_doc_id = ?"; 
                                            $stmt = $mysqli->prepare($ret);
                                            $stmt->bind_param('i', $doc_id);  // Bind the doctor's ID to the query
                                            $stmt->execute();
                                            $res = $stmt->get_result();
                                            $cnt = 1;
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->pat_type;?></td>
                                                     <td>
                                                        <a href="doc_transfer_single_patient.php?pat_number=<?php echo $row->pat_number;?>" class="badge badge-primary"><i class="mdi mdi-check-box-outline "></i> Transfer Patient</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <?php 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Transferred Patients</h4>
                                    <div class="mb-2">
                                        <div class="row">
                                            <div class="col-12 text-sm-center form-inline" >
                                                <div class="form-group mr-2" style="display:none">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone">Referral Hospital</th>
                                                <th data-hide="phone">Transfer Date</th>
                                            </tr>
                                            </thead>
                                            <?php
                                            // Fetch transferred patients assigned to the logged-in doctor
                                            $ret = "SELECT * FROM patient_transfers WHERE t_doc_id = ?";
                                            $stmt = $mysqli->prepare($ret);
                                            $stmt->bind_param('i', $doc_id);  // Bind the doctor's ID to the query
                                            $stmt->execute();
                                            $res = $stmt->get_result();
