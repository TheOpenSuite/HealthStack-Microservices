                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    // Query to count the number of patients assigned to the current doctor
                                                    $result = "SELECT COUNT(*) FROM patients WHERE pat_doc_id = ?";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->bind_param('i', $doc_id); // 'i' indicates integer binding for doc_id
                                                    $stmt->execute();
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                     ...
                                                     */ 
                                                    $result ="SELECT count(*) FROM equipments ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                    ...
                                    <div class="widget-rounded-circle card-box">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="text-right">
                                                    <h3 class="text-dark mt-1"></span></h3>
                                                    <p class="text-muted mb-1 text-truncate">My Payrolls</p>
                                                </div>
                                            </div>
                                        </div> <!-- end row-->
                                    </div>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <?php
                                                // Get the doctor ID from the session (assumed that doc_id is stored in the session)
                                                $doc_id = $_SESSION['doc_id'];

                                                // Modify query to fetch patients assigned to the logged-in doctor
                                                $ret = "SELECT * FROM patients WHERE pat_doc_id = ? ORDER BY RAND() LIMIT 100"; 
                                                $stmt = $mysqli->prepare($ret);
                                                $stmt->bind_param('i', $doc_id); // 'i' indicates integer binding
                                                $stmt->execute();
                                                $res = $stmt->get_result();
                                                $cnt = 1;
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="doc_view_single_patient.php?pat_number=<?php echo $row->pat_number; ?>&&pat_name=<?php echo $row->pat_fname; ?>_<?php echo $row->pat_lname; ?>" class="btn btn-xs btn-outline-success"><i class="mdi mdi-eye"></i> View</a>
                                                    </td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                                                </tr>
                                            </tbody>
                                            <?php } ?>
