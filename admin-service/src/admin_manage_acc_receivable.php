<?php
  ...
  if(isset($_GET['delete_account']))
  {
        ...
        $adn="delete from accounts where acc_number=?";
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <?php
                                                ...
                                                $ret="SELECT * FROM  accounts WHERE acc_type = 'Receivable Account' ORDER BY RAND() "; 
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>USD <?php echo $row->acc_amount;?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="admin_update_single_receivable_account.php?acc_number=<?php echo $row->acc_number;?>" class="badge badge-warning"><i class="fas fa-clipboard-check "></i> Update</a>
                                                        <a href="admin_manage_acc_receivable.php?delete_account=<?php echo $row->acc_number;?>" class="badge badge-danger"><i class="fas fa-trash-alt "></i> Delete</a>
