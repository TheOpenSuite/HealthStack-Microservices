<?php
  ...
  if(isset($_GET['delete_pay_number']))
  {
        ...
        $adn="delete from payrolls where pay_number=?";
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <?php
                                                ...
                                                $ret="SELECT * FROM  payrolls ORDER BY RAND() "; 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <!-- <a href="admin_manage_payrolls.php?delete_pay_number=<?php echo $row->pay_number;?>" class="badge badge-danger"><i class="fas fa-trash"></i> Delete</a> -->
                                                        <a href="admin_generate_single_employee_payroll.php?pay_number=<?php echo $row->pay_number;?>&&pay_doc_number=<?php echo $row->pay_doc_number;?>" class="badge badge-success"><i class="fas fa-file-invoice-dollar "></i> Generate Payroll</a>
