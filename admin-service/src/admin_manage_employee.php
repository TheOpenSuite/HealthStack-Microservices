<?php
  ...
  if(isset($_GET['delete']))
  {
        ...
        if ($type == 'doctor') {
            ...
            $adn="delete from receptionists where receptionist_id=?";
        } else {
                                        ...
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="admin_manage_employee.php?delete=<?php echo $row->id; ?>&type=<?php echo $row->type; ?>" 
                                                        class="badge badge-danger">
                                                        <i class="mdi mdi-trash-can-outline"></i> Delete
                                                        </a>
                                                        <?php if ($row->type == 'doctor') { ?>
                                                            <a href="admin_view_single_employee.php?doc_number=<?php echo $row->number; ?>" 
                                                            class="badge badge-success">
                                                            <i class="mdi mdi-eye"></i> View
                                                            </a>
                                                            <a href="admin_update_single_employee.php?doc_number=<?php echo $row->number; ?>" 
