<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_acc']))
		{
			...
			$query="UPDATE  accounts SET acc_name=?, acc_desc=?, acc_type=?, acc_amount=? WHERE acc_number = ?";
...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                $acc_number=$_GET['acc_number'];
                $ret="SELECT  * FROM accounts WHERE acc_number=?";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputEmail4" class="col-form-label">Account Amount(USD)</label>
