                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM patients WHERE pat_type = 'OutPatient' ";
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM patients WHERE pat_type = 'InPatient' ";
                                                    $stmt = $mysqli->prepare($result);
                                                    $stmt->execute();
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <?php
                                                $ret="SELECT * FROM docs ORDER BY RAND() LIMIT 10 "; 
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="admin_view_single_employee.php?doc_number=<?php echo $row->doc_number;?>" class="btn btn-xs btn-outline-success"><i class="mdi mdi-eye"></i> View</a>
                                                    </td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                                                </tr>
                                            </tbody>
                                            <?php }?>
