<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_payroll']))
		{
			...
			$query="UPDATE   payrolls SET pay_doc_name=?, pay_doc_number=?, pay_doc_email=?, pay_emp_salary=?, pay_descr=?, pay_status = ? WHERE pay_number = ?";
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputEmail4" class="col-form-label">Employee Salary (USD)</label>
