<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient_presc']))
		{
			...
			$query="UPDATE   prescriptions  SET pres_pat_name = ?, pres_pat_type = ?, pres_pat_addr = ?, pres_pat_age = ?, pres_pat_ailment = ?, pres_ins = ? WHERE pres_number = ?";
...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                $pres_number = $_GET['pres_number'];
                $ret="SELECT  * FROM prescriptions WHERE pres_number=?";
