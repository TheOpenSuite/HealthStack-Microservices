<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient_mdr']))
		{
			...
			$query="UPDATE  medical_records SET  mdr_pat_adr = ?, mdr_pat_age = ?,  mdr_pat_prescr = ?, mdr_pat_ailment = ? WHERE mdr_number = ?";
...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                $mdr_number = $_GET['mdr_number'];
                $ret="SELECT  * FROM medical_records WHERE mdr_number=?";
